...
public class ScreenshotManager {
	...
	/**
	 * * Takes a screenshot of the current browser tab * * @param driver - a
	 * WebDriver implementation representing the browser instance
	 */
	...
	/**
	 * * Takes a screenshot of the element at the specified selector. * * @param
	 * driver - a WebDriver implementation representing the browser instance
	...
	/**
	 * * Takes a screenshot of the current browser tab. * * @param driver - a
	 * WebDriver implementation representing the browser instance * @param path -
	 * the string representing the path to save the image, "./images/test-image.png"
	 * would be a valid path as a string * @throws IOException - thrown if the file
	 * couldn't be saved
	 */
	 ...
	 * be a valid path as a string * @throws IOException - thrown if the file
	 * couldn't be saved
	 */
	...
	/**
	 * * Saves the current screenshot in the File object to the specified path, the
	 * last portion of the path is the filename. * <br />
	 * * <br />
	 * * * @param path - the path to save the image, "./images/test-image.png" would
	 * be a valid path as a string * @throws IOException - thrown if the file
	 * couldn't be saved
